...
//     */
//    fun doFilterVal(operation: OperationLog) {
//        //未开启Ip过滤的话直接下一个
...
//        var int = 2
//        //未开启Ip过滤的话直接下一个
//        if (!filterFactory.getAtomicBooleanServletValue2()) return 2
//
//        //创建协程的上下文
//        val coroutineScope = CoroutineScope(Dispatchers.IO)
//        coroutineScope.launch {
...
//                        int = 0
//                        filterFactory.setAtomicBooleanServletValue3(false)
//                        return@launch
//                    }
//                } ?: run {
//                    int = 1
